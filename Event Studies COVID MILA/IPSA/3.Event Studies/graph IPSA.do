import excel "C:Estudio_eventosIPSA.xlsx", sheet("GRAFICOS (2)") cellrange(X1:AY22) firstrow
tsset Tiempo
...
graph export "C:Chile1.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Chile2.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Chile3.pdf", as(jpg) name("Graph") quality(100) replace
clear
