...
#Tres eventos 11/03/2020, 16/03/2020 y 9/02/2021
...
par(mfrow=c(2,2), mar=c(1,1,1,1))
plot(mst[[463]], layout=layout.sphere, main="sphere",vertex.label=nodes2$id)
plot(mst[[463]], layout=layout.circle, main="circle",vertex.label=nodes2$id)
plot(mst[[463]], layout=layout.random, main="random",vertex.label=nodes2$id)
plot(mst[[463]], layout=layout.fruchterman.reingold, main="fruchterman.reingold",vertex.label=nodes2$id)

par(mfrow=c(2,2), mar=c(1,1,1,1))
plot(mst[[699]], layout=layout.sphere, main="sphere",vertex.label=nodes2$id)
plot(mst[[699]], layout=layout.circle, main="circle",vertex.label=nodes2$id)
plot(mst[[699]], layout=layout.random, main="random",vertex.label=nodes2$id)
plot(mst[[699]], layout=layout.fruchterman.reingold, main="fruchterman.reingold",vertex.label=nodes2$id)
...
eigen_mat<-matrix(, nrow = 29, ncol = length(W))
...
write.csv(eigen_mat,'C:pruebaeigen_SPBLPGPP.csv', row.names = TRUE)
write.csv(centr,'C:pruebacent_SPBLPGPP.csv', row.names = TRUE)