import excel "C:Estudio_eventosSPBLPGPP.xlsx", sheet("GRAFICOS (2)") cellrange(X1:AY22) firstrow
tsset Tiempo
...
graph export "C:Peru1.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Peru2.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Peru3.pdf", as(jpg) name("Graph") quality(100) replace
clear
