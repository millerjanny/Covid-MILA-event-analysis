import excel "C:Estudio_eventosCOLCAP.xlsx", sheet("GRAFICOS (2)") cellrange(X1:AY22) firstrow
...
graph export "C:Colombia1.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Colombia2.pdf", as(jpg) name("Graph") quality(100) replace
...
graph export "C:Colombia3.pdf", as(jpg) name("Graph") quality(100) replace
clear
